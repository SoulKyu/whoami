...
func main() {
	...
	e.POST("/deletePage/:id", routes.DeletePageById, middleware.IsLoggedIn)
	e.POST("/updatePage/:id", routes.UpdatePageHandler, middleware.IsLoggedIn)
	...
	e.GET("/pages/:id", routes.TemplatedPages)
